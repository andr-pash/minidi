...
public class QualifierAnnotationTest {
    ...
    public void qualifiedFields_injectCorrectDependencies() {
        ...
        assertThat(dependencyClass.getQualified1()).isExactlyInstanceOf(
                QualifiedClass.QualifiedClass1.class);
        assertThat(dependencyClass.getQualified2()).isExactlyInstanceOf(
                QualifiedClass.QualifiedClass2.class);
    }
}
