...
import com.github.andrpash.minidi.lazy.testclasses.ClassNameReturner;
import com.github.andrpash.minidi.lazy.testclasses.ClassNameReturnerImpl;
import com.github.andrpash.minidi.lazy.testclasses.InvalidLazyAnnotationClass;
import com.github.andrpash.minidi.lazy.testclasses.NoDependencyClass;
import com.github.andrpash.minidi.lazy.testclasses.SimpleValidLazyConstructorClass;
import com.github.andrpash.minidi.lazy.testclasses.SimpleValidLazyFieldClass;
...
public class LazyInitializationTest {
    ...
    public void test_lazyFieldAnnotation_pass() {
        ...
        assertThat(instance.getChild().returnClassName()).isEqualTo(
                ClassNameReturnerImpl.class.getSimpleName());
    }
    ...
    public void test_lazyConstructorParameterAnnotation_pass() {
        final MiniDI.Injector container = MiniDI.create()
                .bind(ClassNameReturner.class).toClass(ClassNameReturnerImpl.class)
                .bind(SimpleValidLazyConstructorClass.class)
                .toClass(SimpleValidLazyConstructorClass.class)
                .initialize();

        final SimpleValidLazyConstructorClass instance = container.get(
                SimpleValidLazyConstructorClass.class);
    ...
    public void test_lazilyConstructedInstancesAreReusedSingleton_pass() {
        ...
        final SimpleValidLazyConstructorClass instance1 = container.get(
                SimpleValidLazyConstructorClass.class);
