...
public class ComplexMiniDITest {
    ...
    public void multiLevelContainer_rootLevelInstancesGetReused() {
        ...
        final MiniDI.Injector rootContainer = MiniDI.create()
                .bind(Level1.Level3.class).withScope(MiniDI.BindingScope.SINGLETON)
                .toClass(Level1.Level3.class)
                .initialize();
    ...
    public void multiLevelContainer_instancesGetReusedFromContainerThatDefinedBinding() {
        ...
        final MiniDI.Injector childContainer1 = rootContainer.createChild()
                .bind(Level1.Level2_1.class).withScope(MiniDI.BindingScope.SINGLETON)
                .toClass(Level1.Level2_1.class)
                .bind(Level1.Level2_2.class).withScope(MiniDI.BindingScope.SINGLETON)
                .toClass(Level1.Level2_2.class)
                .initialize();
    ...
    public void injectInjector_canInjectInjectorAsDependency() {
        ...
        final WithInjectorDependency withInjectorDependency = injector.get(
                WithInjectorDependency.class);
    ...
    public void multiLevelContainer_injectInjector_usedInjectorOfCorrectLevel() {
        ...
        final WithInjectorDependency withInjectorDependency = childInjector.get(
                WithInjectorDependency.class);
