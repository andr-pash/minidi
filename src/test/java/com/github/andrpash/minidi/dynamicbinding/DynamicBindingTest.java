...
public class DynamicBindingTest {
  ...
  public void test_dynamicBindingResolvedFromParentUntilPresentInChildInjector() {
    ...
    final DynamicRootClass instanceFromInjectorBeforeProviding = childInjector.get(
        DynamicRootClass.class);

    childInjector.bindDynamic(DynamicRootClass.class).toInstance(childInstance);
    final DynamicRootClass instanceFromInjectorAfterProviding = childInjector.get(
        DynamicRootClass.class);
