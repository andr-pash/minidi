...
import com.github.andrpash.minidi.simple.testclasses.circular.*;
...
public class DependencyContainerTest
{
	...
	public void test_constructorInjection_simpleDependency( )
	{
		final MiniDI.Injector container = MiniDI.create( )
			.bind( NoDependencyClass.class ).toClass( NoDependencyClass.class )
			.bind( OneConstructorDependencyClass.class ).toClass( OneConstructorDependencyClass.class )
			.initialize( );

		final OneConstructorDependencyClass class1 = container.get( OneConstructorDependencyClass.class );
	...
	public void test_instanceBinding_pass( )
	{
		...
		final OneFieldDependencyClass oneDependencyClassInstance = container.get( OneFieldDependencyClass.class );
		final NoDependencyClass noDependencyClassInstanceFromContainer = container.get( NoDependencyClass.class );
		...
		assertThat( oneDependencyClassInstance.getFirstInstance( ) ).isEqualTo( noDependencyClassInstance );
	}
	...
	{
		MiniDI.create( )
			.bind( DependentOnPrivateConstructorClass.class ).toClass( DependentOnPrivateConstructorClass.class )
	...
	{
		MiniDI.create( )
			.bind( InjectConstructorRefToSelfClass.class ).toClass( InjectConstructorRefToSelfClass.class )
			.initialize( );
	}
	...
	public void test_failedInstantiation_throwsWrappedExpection( )
	{
		...
		assertThat( caughtException )
			.hasRootCauseExactlyInstanceOf( ThrowingConstructorClass.ThrowingConstructorClassException.class );
	}
}